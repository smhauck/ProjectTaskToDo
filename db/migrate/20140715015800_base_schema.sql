...
--
-- Table structure for table `note_privacy_type`
--

DROP TABLE IF EXISTS `note_privacy_type`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `note_privacy_type` (
  `id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `active` char(1) NOT NULL DEFAULT '1',
  `title` varchar(255) NOT NULL DEFAULT 'NEED TITLE',
  `description` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `notification` (
  ...
  `body` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4688 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `schema_migration` (`version`) VALUES ('20140715015800');
UNLOCK TABLES;
...
-- Dump completed on 2014-07-12 22:16:44
