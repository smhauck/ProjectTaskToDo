...
my $open_result = $mailer->open( \%mail_headers );
print $mailer
"<br />\n<h1>Password Reset Request</h1>\nThis is an automated message from ProjectTaskToDo to let you know you have a new password.\n<hr />\n<br /><br />\n";
print $mailer "Your new password is: $password<br />\n";
print $mailer "Thank you<br />\n";
$mailer->close;
